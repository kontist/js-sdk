...
var user_1 = require("../../lib/graphql/user");
describe("User", function () {
    ...
    describe("#fetch", function () {
        it("should fail", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = new user_1.User(client.graphQL);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 4:
                        ...
                        chai_1.expect(error.message).to.eq("You are allowed only to fetch your details.");
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("#get", function () {
        it("should call rawQuery and return mainAccount", function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, viewer, spyOnRawQuery, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = new user_1.User(client.graphQL);
                        viewer = { email: "test@kontist.com" };
                        spyOnRawQuery = sandbox.stub(client.graphQL, "rawQuery").resolves({ viewer: viewer });
                        return [4 /*yield*/, user.get()];
                    case 1:
                        result = _a.sent();
                        // assert
                        sinon.assert.calledOnce(spyOnRawQuery);
                        chai_1.expect(result).to.eq(viewer);
                        return [2 /*return*/];
                }
            });
        }); });
