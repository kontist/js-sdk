...
export type AccountInsight = {|
  ...
  expense: $ElementType<Scalars, 'Int'>,
  income: $ElementType<Scalars, 'Int'>,
  period: Period,
  profitAndLoss: $ElementType<Scalars, 'Int'>,
|};

export type AccountInsightV2 = {|
  __typename?: 'AccountInsightV2',
  expense: Insight,
  income: Insight,
  period: Period,
...
export type Query = {|
  ...
  insightsV2: Array<AccountInsightV2>,
