...
export type User = {|
  ...
  invoice?: ?Invoice,
  invoicingDashboardData: InvoicingDashboardData,
|};
...
export type UserInvoicingDashboardDataArgs = {|
  pageNumber: $ElementType<Scalars, 'Float'>,
|};
...
export type InvoicingDashboardData = {|
  ...
  hasNextPage: $ElementType<Scalars, 'Boolean'>,
  hasPreviousPage: $ElementType<Scalars, 'Boolean'>,
  currentPage: $ElementType<Scalars, 'Float'>,
