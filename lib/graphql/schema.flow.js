...
export type AccountBalanceResponse = {|
  ...
  available_balance?: ?SolarisBalance,
  balance?: ?SolarisBalance,
  seizure_protection?: ?SeizureProtection,
|};
...
export const ExternalBookkeepingDocumentTypeValues = Object.freeze({
  Advisor: 'ADVISOR',
  Manual: 'MANUAL',
  Tool: 'TOOL'
});
...
export type ExternalBookkeepingDocumentType = $Values<typeof ExternalBookkeepingDocumentTypeValues>;

export type FibuFinalCheckDocumentTask = {|
  ...FibuFinalCheckTask,
  ...{|
...
export type GenericFibuFinalCheckTask = {|
  ...FibuFinalCheckTask,
  ...{|
...
export type SeizureProtection = {|
  ...
  protected_amount_expiring_date: $ElementType<Scalars, 'String'>,
|};
...
export type TaxCase = {|
  __typename?: 'TaxCase',
  assignee?: ?$ElementType<Scalars, 'String'>,
